...
The dataset will include traffic-based features extracted for each activity interval.  

### **Key Features**:
- **Packet Characteristics**:  
  - Average size of packets per second, number of packets passed per second, and timing intervals between corresponding packets.   
